...
//                    gbAdd(pJob,1,6,3,1);
             ...
             private void setLayout(GridBagLayout gb2) {
...
//           +++++++++++++++++++     jTable내용 갱신 메소드 호출
       ...
       //DTO setter/ getter  순수 데이터 객체 주고받는데 사용
       //DAO DATA접근 한다. 로직 있는 데이터 접근, CRUD API를 제공객체, crud 관여 필요함.
       ...
       // +++++++++++++++++++   화면에서 사용자가 입력한 내용을 얻는다.
           	  MemberDTO dto = getViewData();   //DTO setter/ getter  주고받는데 사용   
           	  MemberDAO dao = new MemberDAO();   //DAO crud 관여 필요함.     
